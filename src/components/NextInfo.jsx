...
<input
  ...
  onChange={(e) => setFormData({ ...formData, kindAr: e.target.value })}
/>
<input
  type="text"
  className="form-group"
  ...
  onChange={(e) => setFormData({ ...formData, breederAr: e.target.value })}
/>
<input
  type="text"
  className="form-group"
  ...
  onChange={(e) => setFormData({ ...formData, pedigreeAr: e.target.value })}
/>
</div>
</div>
